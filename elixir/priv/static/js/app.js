...
!function (e, t) {
  ...
  return function (e) {
    ...
    var b = function (e) {
      return function (t, n, i) {
        ...
        var u = i.getNodeKey || y,
            ...
            k = i.onElUpdated || g,
            w = i.onBeforeNodeDiscarded || g,
            x = i.onNodeDiscarded || g,
            E = i.onBeforeElChildrenUpdated || g,
            A = !0 === i.childrenOnly,
          ...
          "TEXTAREA" !== t.nodeName ? function (e, t) {
            ...
            e: for (; d;) {
              for (o = d.nextSibling, n = u(d); v;) {
                ...
                if (g === d.nodeType && (g === f ? (n ? n !== i && ((s = C[n]) ? r === s ? y = !1 : (e.insertBefore(s, v), i ? P(i) : L(v, e, !0), v = s) : y = !1) : i && (y = !1), (y = !1 !== y && l(v, d)) && I(v, d)) : g !== p && g != m || (y = !0, v.nodeValue !== d.nodeValue && (v.nodeValue = d.nodeValue))), y) {
                  d = o, v = r;
                  continue e;
                }
        ...
        var N = t,
            D = N.nodeType,
            O = n.nodeType;
        if (!A) if (D === f) O === f ? l(t, n) || (x(t), N = function (e, t) {
        ...
        }(n.nodeName, n.namespaceURI))) : N = n;else if (D === p || D === m) {
          if (O === D) return N.nodeValue !== n.nodeValue && (N.nodeValue = n.nodeValue), N;
          N = n;
        }
        if (N === n) x(t);else {
          if (n.isSameNode && n.isSameNode(N)) return;
          if (I(N, n, A), S) for (var _ = 0, R = S.length; _ < R; _++) {
            var j = C[S[_]];
            j && L(j, j.parentNode, !1);
          }
        }
        return !A && N !== t && t.parentNode && (N.actualize && (N = N.actualize(t.ownerDocument || a)), t.parentNode.replaceChild(N, t)), N;
      };
    }(function (e, t) {
      var n,
          i,
    ...
    var D = [1e3, 3e3],
        O = "data-phx-view",
        _ = ["phx-click-loading", "phx-change-loading", "phx-submit-loading", "phx-keydown-loading", "phx-keyup-loading", "phx-blur-loading", "phx-focus-loading"],
        R = "data-phx-component",
        j = "data-phx-ref",
        H = "[".concat(O, "]"),
        M = ["text", "textarea", "number", "email", "password", "search", "tel", "url", "date", "time"],
        B = ["checkbox", "radio"],
        J = 1,
        F = "phx-",
        U = {
    ...
    var q = function (e, t, n, i) {
      ...
      } while (null !== e && 1 === e.nodeType && !(n && n.isSameNode(e) || e.matches(H)));
      ...
      return C(e, [{
        ...
        value: function (e, t) {
          for (var n in t) {
            var i = t[n],
                r = e[n];
            z(i) && z(r) ? (r.d && !i.d && delete r.d, this.recursiveMerge(r, i)) : e[n] = i;
          }
        }
      }, {
        ...
        key: "dynamicToBuffer",
        value: function (e, t) {
          "number" == typeof e ? t.buffer += this.recursiveCIDToString(t.components, e, t.onlyCids) : z(e) ? this.toOutputBuffer(e, t) : t.buffer += e;
        }
      }, {
        key: "recursiveCIDToString",
        value: function (e, t, n) {
          var i = this,
              r = e[t] || V("no component for CID ".concat(t), e),
              o = document.createElement("template");
          o.innerHTML = this.recursiveToString(r, e, n);
          var a = o.content,
              u = n && !n.has(t);
          return Array.from(a.childNodes).forEach(function (e, n) {
            if (e.nodeType === Node.ELEMENT_NODE) e.setAttribute(R, t), e.id || (e.id = "".concat(i.parentViewId(), "-").concat(t, "-").concat(n)), u && (e.setAttribute("data-phx-skip", ""), e.innerHTML = "");else if ("" !== e.nodeValue.trim()) {
              V("only HTML element tags are allowed at the root of components.\n\n" + 'got: "'.concat(e.nodeValue.trim(), '"\n\n') + "within:\n", o.innerHTML.trim());
              var r = document.createElement("span");
              r.innerText = e.nodeValue, r.setAttribute(R, t), e.replaceWith(r);
            } else e.remove();
          }), o.innerHTML;
        }
      }]), e;
      ...
      function e(t, n) {
        ...
        this.socket = new n(t, r), this.bindingPrefix = r.bindingPrefix || F, this.opts = r, this.params = W(r.params || {}), this.viewLogger = r.viewLogger, this.metadataCallbacks = r.metadata || {}, this.defaults = Object.assign(K(U), r.defaults || {}), this.activeElement = null, this.prevActive = null, this.silenced = !1, this.main = null, this.linkRef = 0, this.roots = {}, this.href = window.location.href, this.pendingLink = null, this.currentLocation = K(window.location), this.hooks = r.hooks || {}, this.loaderTimeout = r.loaderTimeout || J, this.boundTopLevelEvents = !1, window.addEventListener("unload", function (e) {
          i.unloaded = !0;
      ...
      return C(e, [{
        ...
        value: function (e) {
          ...
          var n = D[0],
              ...
              o = ee.updateLocal(e.name(), "consecutive-reloads", 0, function (e) {
            return e + 1;
          });
        ...
        value: function () {
          var e = this,
              t = !1;
          return te.all(document, "".concat(H, ":not([").concat("data-phx-parent-id", "])"), function (n) {
        ...
        key: "redirect",
        value: function (e, t) {
          this.disconnect(), ee.redirect(e, t);
        }
      }, {
        key: "replaceMain",
        value: function (e, t) {
          var n = this,
              ...
              o = this.main.el;
          this.main.showLoader(this.loaderTimeout), this.main.destroy(), ee.fetchPage(e, function (a, u) {
        ...
        value: function (e, t, n) {
          ...
          if (/^(0|[1-9](\d?)+)$/.test(t)) {
            var r = e || te.findFirstComponentNode(document, t);
        ...
        value: function (e, t) {
          var n = this,
            ...
            n.on(r, function (e) {
              ...
              }) : te.all(document, "[".concat(o, "]"), function (r) {
        ...
        value: function () {
          ...
          [!0, !1].forEach(function (t) {
            ...
            window.addEventListener("click", function (i) {
              var r = null,
                  o = (r = t ? i.target.matches("[".concat(n, "]")) ? i.target : i.target.querySelector("[".concat(n, "]")) : $(i.target, n)) && r.getAttribute(n);
        ...
        value: function () {
          var e = this;
          ee.canPushState() && (window.onpopstate = function (t) {
        ...
        key: "withPageLoading",
        value: function (e, t) {
          te.dispatchEvent(window, "phx:page-loading-start", e);

          var n = function () {
            return te.dispatchEvent(window, "phx:page-loading-stop", e);
          };
        ...
        value: function (e) {
          ...
          return t.pathname + t.search !== e.pathname + e.search && (this.currentLocation = K(e), !0);
        }
      }, {
        key: "bindForms",
        value: function () {
          ...
          for (var n = function () {
            ...
            e.on(n, function (i) {
              ...
              if (o && ("number" !== r.type || !r.validity || !r.validity.badInput)) {
                var a = t;
                t++;
                var u = te.private(r, "prev-iteration") || {},
                    c = u.at,
                    s = u.type;
                c === a - 1 && n !== s || (te.putPrivate(r, "prev-iteration", {
                  at: a,
                  type: n
                }), e.debounce(r, i, function () {
                  e.withinOwners(r.form, function (t, n) {
                    te.isTextualInput(r) ? te.putPrivate(r, "phx-has-focused", !0) : e.setActiveElement(r), t.pushInput(r, n, o, i.target);
                  });
                }));
              }
            }, !1);
        ...
        n.open("GET", e, !0), n.timeout = 3e4, n.setRequestHeader("content-type", "text/html"), n.setRequestHeader("cache-control", "max-age=0, no-cache, no-store, must-revalidate, post-check=0, pre-check=0"), n.setRequestHeader("x-requested-with", "live-link"), n.onerror = function () {
          ...
          if (4 === n.readyState) {
            var i = new URL(e),
                ...
                o = new URL(n.getResponseHeader("x-response-url")),
                a = o.pathname + o.search;
            return "live-link" !== n.getResponseHeader("x-requested-with") ? t(400) : a != r ? t(302) : 200 !== n.status ? t(n.status) : void t(200, n.responseText);
          }
        }, n.send();
      },
      ...
      redirect: function (e, t) {
        t && ee.setCookie("__phoenix_flash__", t + "; max-age=60000; path=/"), window.location = e;
      },
      ...
      getHashTargetEl: function (e) {
        ...
        te = {
      byId: function (e) {
        return document.getElementById(e) || V("no id found for ".concat(e));
      },
      ...
      findFirstComponentNode: function (e, t) {
        return e.querySelector("[".concat(R, '="').concat(t, '"]'));
      },
      findComponentNodeList: function (e, t) {
        return this.all(e, "[".concat(R, '="').concat(t, '"]'));
      },
      ...
      findPhxChildren: function (e, t) {
        return this.all(e, "".concat(H, "[").concat("data-phx-parent-id", '="').concat(t, '"]'));
      },
      findParentCIDs: function (e, t) {
        var n = this,
            i = new Set(t);
        return t.reduce(function (t, i) {
          var r = "[".concat(R, '="').concat(i, '"] [').concat(R, "]");
          return n.all(e, r).map(function (e) {
            return parseInt(e.getAttribute(R));
          }).forEach(function (e) {
            return t.delete(e);
          }), t;
        }, i);
      ...
      copyPrivates: function (e, t) {
        t.phxPrivate && (e.phxPrivate = K(t.phxPrivate));
      },
      putTitle: function (e) {
      ...
      debounce: function (e, t, n, i, r, o, a) {
        ...
        switch (l) {
          ...
          default:
            var d = parseInt(l);
            if (isNaN(d)) return V("invalid throttle/debounce value: ".concat(l));
            ...
            var f = function (t) {
              s && "phx-change" === t.type && t.detail.triggeredBy.name === e.name || (clearTimeout(u.private(e, "debounce-timer")), u.deletePrivate(e, "debounce-timer"));
                ...
                v = function () {
              e.form && (e.form.removeEventListener("phx-change", f), e.form.removeEventListener("submit", f)), e.removeEventListener("blur", u.private(e, "debounce-blur-timer")), s || e.removeEventListener("keydown", f), u.deletePrivate(e, "debounce-blur-timer"), u.deletePrivate(e, "debounce-timer"), s || a();
            },
                p = function () {
              clearTimeout(u.private(e, "debounce-timer")), v();
            };

            this.putPrivate(e, "debounce-timer", setTimeout(v, d)), e.addEventListener("blur", p), s || e.addEventListener("keydown", f), this.putPrivate(e, "debounce-blur-timer", p), e.form && (e.form.addEventListener("phx-change", f), e.form.addEventListener("submit", f)), s && a();
        }
      },
      ...
      mergeFocusedInput: function (e, t) {
        e instanceof HTMLSelectElement || te.mergeAttrs(e, t, ["value"]), t.readOnly ? e.setAttribute("readonly", !0) : e.removeAttribute("readonly");
      },
      restoreFocus: function (e, t, n) {
        if (te.isTextualInput(e)) {
      ...
      syncAttrsToProps: function (e) {
        e instanceof HTMLInputElement && B.indexOf(e.type.toLocaleLowerCase()) >= 0 && (e.checked = null !== e.getAttribute("checked"));
      },
      isTextualInput: function (e) {
        return M.indexOf(e.type) >= 0;
      },
      ...
      undoRefs: function (e, t) {
        var n = this;
        te.all(t, "[".concat(j, "]"), function (t) {
          return n.syncPendingRef(e, t, t);
        });
      },
      syncPendingRef: function (e, t, n) {
        var i = t.getAttribute && t.getAttribute(j);
        if (null === i) return !0;
        var r = parseInt(i);
        return null !== e && e >= r ? ([t, n].forEach(function (e) {
          e.removeAttribute(j), null !== e.getAttribute("data-phx-readonly") && (e.readOnly = !1, e.removeAttribute("data-phx-readonly")), null !== e.getAttribute("data-phx-disabled") && (e.disabled = !1, e.removeAttribute("data-phx-disabled")), _.forEach(function (t) {
            return te.removeClass(e, t);
          });
          var t = e.getAttribute("data-phx-disable-with-restore");
          null !== t && (e.innerText = t, e.removeAttribute("data-phx-disable-with-restore"));
        }), !0) : (_.forEach(function (e) {
          t.classList.contains(e) && n.classList.add(e);
        }), n.setAttribute(j, t.getAttribute(j)), !te.isFormInput(t) && !/submit/i.test(t.type));
      }
    },
        ne = function () {
      ...
      return C(e, [{
        ...
        value: function () {
          te.all(this.container, "[phx-update=append] > *, [phx-update=prepend] > *", function (e) {
        ...
        value: function () {
          ...
          if (!this.isCIDPatch() || o) {
            ...
            return this.trackBefore("added", i), this.trackBefore("updated", i, i), n.time("morphdom", function () {
              b(o, m, {
                childrenOnly: null === o.getAttribute(R),
                onBeforeNodeAdded: function (t) {
                  return te.discardError(o, t, d), e.trackBefore("added", t), t;
                },
                onNodeAdded: function (n) {
                  te.isNowTriggerFormExternal(n, h) && n.submit(), te.isPhxChild(n) && t.ownsElement(n) && e.trackAfter("phxChildAdded", n), f.push(n);
                },
                onNodeDiscarded: function (t) {
                  e.trackAfter("discarded", t);
                },
                onBeforeNodeDiscarded: function (t) {
                  return !(!t.getAttribute || null === t.getAttribute("data-phx-remove")) || (null === t.parentNode || !te.isPhxUpdate(t.parentNode, l, ["append", "prepend"])) && !e.skipCIDSibling(t) && (e.trackBefore("discarded", t), te.isPhxChild(t) ? (n.destroyViewByEl(t), !0) : void 0);
                },
                onElUpdated: function (e) {
                  te.isNowTriggerFormExternal(e, h) && e.submit(), v.push(e);
                },
                onBeforeElUpdated: function (t, n) {
                  if (e.skipCIDSibling(n)) return !1;
                  if ("ignore" === t.getAttribute(l)) return e.trackBefore("updated", t, n), te.mergeAttrs(t, n), v.push(t), !1;
                  if ("number" === t.type && t.validity && t.validity.badInput) return !1;
                  if (!te.syncPendingRef(e.ref, t, n)) return !1;

                  if (te.isPhxChild(n)) {
                    var i = t.getAttribute("data-phx-static");
                    return te.mergeAttrs(t, n), t.setAttribute("data-phx-static", i), t.setAttribute("data-phx-root-id", e.rootID), !1;
                  }

                  if (te.copyPrivates(n, t), te.discardError(o, n, d), a && t.isSameNode(a) && te.isFormInput(t) && !e.forceFocusedSelectUpdate(t, n)) return e.trackBefore("updated", t, n), te.mergeFocusedInput(t, n), te.syncAttrsToProps(t), v.push(t), !1;

                  if (te.isPhxUpdate(n, l, ["append", "prepend"])) {
                  ...
                  return te.syncAttrsToProps(n), e.trackBefore("updated", t, n), !0;
                }
              });
              ...
              p.forEach(function (e) {
                ...
                "append" === r.getAttribute(l) ? i.reverse().forEach(function (e) {
                  G(document.getElementById(e), function (e) {
              ...
              return te.restoreFocus(a, c, s);
            }), te.dispatchEvent(document, "phx:update"), f.forEach(function (t) {
        ...
        value: function () {
          if (this.isCIDPatch()) {
            var e = k(te.findComponentNodeList(this.container, this.targetCID)),
                t = e[0];
        ...
        value: function (e, t, n, i) {
          var r = this,
              o = this.isCIDPatch(),
              a = o && i.getAttribute(R) === this.targetCID.toString();
          if (!o || a) return t;
          var u = null,
              c = document.createElement("template");
          u = te.cloneNode(i);
          var s = k(te.findComponentNodeList(u, this.targetCID)),
              l = s[0],
              d = s.slice(1);
          return c.innerHTML = t, d.forEach(function (e) {
            return e.remove();
          }), Array.from(u.childNodes).forEach(function (e) {
            e.nodeType === Node.ELEMENT_NODE && e.getAttribute(R) !== r.targetCID.toString() && (e.setAttribute("data-phx-skip", ""), e.innerHTML = "");
      ...
      return C(e, [{
        ...
        value: function () {
          var e = this.liveSocket.params(this.view),
              t = te.all(document, "[".concat(this.binding("track-static"), "]")).map(function (e) {
            return e.src || e.href;
          }).filter(function (e) {
        ...
        value: function (e) {
          ...
          this.joinCount++, this.childJoins = 0, this.joinPending = !0, this.flash = null, this.log("join", function () {
            return ["", n];
          }), n.title && te.putTitle(n.title), ee.dropLocal(this.name(), "consecutive-reloads"), this.rendered = new Q(this.id, n);
        ...
        key: "dropPendingRefs",
        value: function () {
          te.all(this.el, "[".concat(j, "]"), function (e) {
            return e.removeAttribute(j);
          });
        }
      }, {
        key: "onJoinComplete",
        value: function (e, t) {
          ...
          0 === te.findPhxChildrenInFragment(t, this.id).filter(function (e) {
        ...
        key: "attachTrueDocEl",
        value: function () {
          this.el = te.byId(this.id), this.el.setAttribute("data-phx-root-id", this.root.id);
        }
      }, {
        key: "applyJoinPatch",
        value: function (e, t) {
          ...
          var i = new ne(this, this.el, this.id, t, null);

          if (i.markPrunableContentForRemoval(), this.joinPending = !1, this.performPatch(i), this.joinNewChildren(), te.all(this.el, "[".concat(this.binding("hook"), "]"), function (e) {
            var t = n.addHook(e);
        ...
        value: function () {
          var e = this;
          te.findPhxChildren(this.el, this.id).forEach(function (t) {
        ...
        value: function (e, t, n) {
          ...
          if (!X(e) || null !== n) {
            if (e.title && te.putTitle(e.title), this.isJoinPending() || this.liveSocket.hasPendingLink()) return this.pendingDiffs.push({
              diff: e,
              cid: t,
              ref: n
            });
            ...
            "number" == typeof t ? this.liveSocket.time("component ack patch complete", function () {
              ...
              te.findParentCIDs(i.el, i.rendered.componentCIDs(e)).forEach(function (t) {
                i.componentPatch(e.c[t], t, n) && (r = !0);
              });
            }) : X(e) || this.liveSocket.time("full patch complete", function () {
              var t = i.renderContainer(e, "update"),
                  o = new ne(i, i.el, i.id, t, null, n);
              r = i.performPatch(o);
            }), te.undoRefs(n, this.el), r && this.joinNewChildren();
          }
        }
      }, {
        key: "renderContainer",
        ...
        value: function (e, t, n) {
          ...
          var i = this.rendered.componentToString(t),
              r = new ne(this, this.el, this.id, i, t, n);
          return this.performPatch(r);
        }
      }, {
        key: "getHook",
        value: function (e) {
          return this.viewHooks[oe.elementID(e)];
        }
      }, {
        key: "addHook",
        value: function (e) {
          if (!oe.elementID(e) && e.getAttribute) {
            ...
            if (!t || this.ownsElement(e)) {
              ...
              if (n) {
                var i = new oe(this, e, n);
                return this.viewHooks[oe.elementID(i.el)] = i, i;
              }

              null !== t && V('unknown hook found for "'.concat(t, '"'), e);
            }
          }
        }
      }, {
        key: "destroyHook",
        value: function (e) {
          e.__trigger__("destroyed"), delete this.viewHooks[oe.elementID(e.el)];
        }
      }, {
        ...
        key: "onJoinError",
        value: function (e) {
          return (e.redirect || e.live_redirect) && this.channel.leave(), e.redirect ? this.onRedirect(e.redirect) : e.live_redirect ? this.onLiveRedirect(e.live_redirect) : (this.log("error", function () {
        ...
        key: "displayError",
        value: function () {
          this.isMain() && te.dispatchEvent(window, "phx:page-loading-start", {
            to: this.href,
            kind: "error"
        ...
        value: function (e, t) {
          ...
          return e.forEach(function (e) {
            e.classList.add("phx-".concat(t, "-loading")), e.setAttribute(j, n);
        ...
        key: "componentID",
        value: function (e) {
          var t = e.getAttribute && e.getAttribute(R);
        ...
        value: function (e) {
          var t = this;
          return e ? G(e.closest("[".concat(R, "]")), function (e) {
        ...
        value: function (e, t) {
          ...
          return void 0 !== e.value && (t.value = e.value, "INPUT" === e.tagName && B.indexOf(e.type) >= 0 && !e.checked && delete t.value), t;
        }
      }, {
        key: "pushEvent",
        ...
        value: function (e, t, n, i, r) {
          var o = this;
          te.dispatchEvent(e.form, "phx-change", {
            triggeredBy: e
          }), this.pushWithReply(function () {
        ...
        value: function (e, t, n, i) {
          var r = this,
              o = function (e) {
            return !$(e, "".concat(r.binding("update"), "=ignore"), e.form);
          };

          this.pushWithReply(function () {
            var t = te.all(e, "[".concat(r.binding("disable-with"), "]")),
                n = te.all(e, "button").filter(o),
                i = te.all(e, "input").filter(o);
        ...
        value: function (e) {
          ...
          return i.innerHTML = e, te.all(this.el, "form[".concat(n, "]")).filter(function (e) {
        ...
        value: function (e) {
          var t = this,
            ...
            return 0 === te.findComponentNodeList(t.el, e).length;
          });
        ...
        key: "ownsElement",
        value: function (e) {
          return e.getAttribute("data-phx-parent-id") === this.id || G(e.closest(H), function (e) {
            return e.id;
          }) === this.id;
        }
      }, {
        ...
        value: function (e, t, n) {
          var i = this;
          te.putPrivate(e, "phx-has-submitted", !0), this.liveSocket.blurActiveElement(this), this.pushFormSubmit(e, t, n, function () {
